      ...
      connectedInputsCond = do
        ...
        where
          ...
          getOptions (occur,input) di dj forcing =
            ...
            r4 options tag vv v aa a ii i l =
              if a /= 5 then r5 options tag vv v aa a ii i l
              else if i == l-1 then 
                r6 options tag vv v aa a ii i l
              else 
                r5 options tag vv (vv!!(i+1)) aa 1 ii (i+1) l
            ...
            undoForcedMove l aa vv tag =
              --if occur ==3 && vv!!0 == (4,2) && vv!!1 == (4,1) && then error (show vv) else
